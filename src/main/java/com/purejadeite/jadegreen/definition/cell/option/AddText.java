...
public class AddText extends AbstractStringCellConverter {
	...
	public AddText(Map<String, Object> config) {
		super();
		this.prefix = RoughlyMapUtils.getString(config, "prefix");
		this.suffix = RoughlyMapUtils.getString(config, "suffix");
		this.ignoreEmpty = RoughlyMapUtils.getBooleanValue(config, "ignoreEmpty");
	}
